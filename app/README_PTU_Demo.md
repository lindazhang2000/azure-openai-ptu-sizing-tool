...
2. Pick a **Deployment type** — `Global`, `Data Zone`, or `Regional`. Global/Data Zone use the lower minimums (e.g. 15 PTUs, 5 increment); Regional uses larger model-specific minimums (e.g. 50/50 or 25/25). Only the types each model supports are listed.
